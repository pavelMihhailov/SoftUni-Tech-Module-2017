...
public class IntersectionOfCircles {
    public static void main(String[] args) {
        ...
        int[] dimensions1 = Arrays.stream(scanner.nextLine().split("\\s"))
                .mapToInt(Integer::parseInt).toArray();

        int[] dimensions2 = Arrays.stream(scanner.nextLine().split("\\s"))
                .mapToInt(Integer::parseInt).toArray();
        ...
        if(circlesIntersect(circle1, circle2)) System.out.println("Yes");
